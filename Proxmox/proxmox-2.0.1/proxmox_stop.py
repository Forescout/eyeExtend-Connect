"""
Proxmox Connect App - Stop Action
Force stops a running VM or LXC container (immediate power off).
"""
...
try:
    ...
    logging.error(f"Proxmox stop failed: HTTP {status_code}")
except Exception as e:
    logging.exception(e)
    response["succeeded"] = False
    response["troubleshooting"] = f"Failed to stop {guest_type}/{vmid}: {str(e)}"
