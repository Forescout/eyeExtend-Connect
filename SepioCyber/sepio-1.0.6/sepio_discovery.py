...
logging.info(f"DORMANT_DEVICE_CREATION flag is set to: {DORMANT_DEVICE_CREATION}")
...
def fetch_assets_data(token):
    ...
    all_assets = []
    page_number = 1
    PAGE_SIZE = 4000  # Number of assets per page
...
if token:
    ...
    logging.error("No authentication token retrieved")
...
try:
                ...
                for asset in assets:
                    ...
                    logging.info(f"Exporting assets: {endpoint}")
...
logging.info("Assets processing completed successfully.")
