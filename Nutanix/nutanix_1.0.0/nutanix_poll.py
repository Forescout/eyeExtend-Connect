...
def get_vm_endpoint(vm: dict, endpoints:list)->list: # returns endpoints list after appending the new endpoints 
    ...
    if len(mac_list)>0 or len(ip_list)>0: 
        ...
        properties['is_agent_vm'] = get_property(vm, 'status.resources.is_agent_vm').lower()
        ...
        properties['vga_console_enabled'] = get_property(vm, 'status.resources.vga_console_enabled').lower()
        ...
        properties['enable_cpu_passthrough'] = get_property(vm, 'status.resources.enable_cpu_passthrough').lower()
        properties['disable_branding'] = get_property(vm, 'status.resources.disable_branding').lower()
