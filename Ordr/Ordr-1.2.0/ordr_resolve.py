        ...
        if resp.status_code == 200 :
            ...
            if len(detail) > 0 :
                ...
                if "isBlacklisted" in detail:
                    properties["connect_ordr_blocklistStatus"] = str(detail['isBlacklisted'])
                    logging.debug("connect_ordr_blocklistStatus : " + str(detail['isBlacklisted']))
                else:
                    properties["connect_ordr_blocklistStatus"] = ""
